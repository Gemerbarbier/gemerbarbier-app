...
@Validated
@Tag(name = "Barber", description = "the Barber API")
public interface BarberApi {
     ...
     *
     * @return List of barbers (status code 200)
     */
    @Operation(
        ...
        tags = { "Barber" },
        responses = {
            @ApiResponse(responseCode = "200", description = "List of barbers", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = BarberResponseDto.class)))
            })
        }
    )
    @RequestMapping(
    ...
    default ResponseEntity<List<BarberResponseDto>> getBarbers(
