...
const SERVICE_CONFIG_LIST: Array<{
  match: string;
  bg: string;
  border: string;
  text: string;
  ...
  {
    match: "exclusive strih & úprava brady",
    bg: "bg-violet-500/20",
  ...
  {
    match: "obyčajný strih & úprava brady",
    bg: "bg-cyan-500/20",
  ...
  return (
      <div className="min-h-screen bg-background">
        ...
        <header className="bg-card border-b border-border sticky top-0 z-50">
          <div
              className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" size="sm"
                          className="font-semibold gap-1 sm:gap-2 text-xs sm:text-sm h-8 sm:h-9 px-2 sm:px-3">
                    <span
                        className="hidden sm:inline">{new Date(weekDates[0]).toLocaleDateString("sk-SK", {
                      month: "long",
                      year: "numeric"
                    })}</span>
                    <span
                        className="sm:hidden">{new Date(weekDates[0]).toLocaleDateString("sk-SK", {
                      month: "short",
                      year: "2-digit"
                    })}</span>
                ...
                <div
                  ...
                  <Dialog open={isAddReservationOpen} onOpenChange={(open) => {
                    ...
                    <DialogTrigger asChild>
                      <Button size="sm"
                              className="bg-accent text-accent-foreground hover:bg-accent/80 gap-1 sm:gap-2 text-xs sm:text-sm w-full sm:w-auto"
                    ...
                    <DialogContent
                        className="bg-card max-h-[90vh] overflow-y-auto max-w-[95vw] sm:max-w-lg">
                      <DialogHeader>
                        <DialogTitle className="text-base sm:text-lg">Vytvoriť novú
                          rezerváciu</DialogTitle>
                      </DialogHeader>
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        <div>
                          ...
                          <Select
                              ...
                              onValueChange={(value) => setNewReservation({
                                ...newReservation,
                                serviceId: value,
                                date: "",
                                time: ""
                          ...
                          >
                            <SelectTrigger>
                              <SelectValue
                                  placeholder={isLoadingServices ? "Načítavam..." : "Vyberte službu"}/>
                            </SelectTrigger>
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <span className="text-sm sm:text-base font-bold text-accent">
                                    ...
                                    {reservation.cutServiceName}
                                      ...
                                      {/* Additional details */}
                                      <div
                                          className="flex flex-wrap items-center gap-2 sm:gap-3 mt-1.5">
                  ...
                  <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          if (response.success) {
                            toast({
                              title: "Sloty deaktivované",
                              description: "Všetky časové sloty boli deaktivované."
                            });
                            fetchTimeSlots();
                          } else {
                            toast({
                              title: "Chyba",
                              description: response.error?.message || "Nepodarilo sa deaktivovať sloty.",
                              variant: "destructive"
                            });
                          }
                        } catch {
                          toast({
                            title: "Chyba",
                            description: "Nepodarilo sa deaktivovať sloty.",
                            variant: "destructive"
                          });
                        }
                      }}
                          ...
                          return (
                            ...
                            {isInactive ? "Vyhodený" : isReserved ? "Obsadený" : "Voľný"}
                                ...
                                {!isReserved && (
                                    ...
                                    >
                                      {isInactive ? <Check className="w-3 h-3"/> :
                                          <X className="w-3 h-3"/>}
                                    </Button>
                                )}
                              </div>
