        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Založené s vášňou pre precíznosť a štýl, spájame tradičné barberské
          ...
          <div className="bg-card border border-border rounded-lg p-8 md:p-12 shadow-deep animate-fade-in">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                ...
                Náš barbershop spája nadčasové tradície klasického barbershopu s modernými technikami a štýlom.
              </p>
              <p>
